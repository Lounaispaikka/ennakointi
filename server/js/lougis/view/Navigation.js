    ...
    initComponent: function () {
        this.toolbar = Ext.create('Ext.toolbar.Toolbar', {
            items: [
				...
				{	
					text: "Näytä julkinen sivu",
					href: '../../'
				},
				{	
                    icon: '/img/icons/16x16/setting_tools.png',
                    target: '/tools',
                    text: 'Ennakointityökalut',
                    xtype: 'splitbutton',
                    menu: {
                        xtype: 'menu',
                        items: [
							...
							/*{
                                ...
                                target: '/tools/tietopankki'
                            },*/
							{
                                text: "Toimialat",
                                icon: '/img/icons/16x16/showel.png',
                                target: '/tools/toimialat'
                            }
							/*{
                                text: "Ennakointitilastot",
                                icon: '/img/icons/16x16/table_chart.png',
                                target: '/tools/ennakointicharts'
                            },  
							{
                                text: "Ennakointiteemat",
                                icon: '/img/icons/16x16/time_go.png',
                                target: '/tools/ennakointi'
                            },
							{
								text: "LouSurvey - kyselylomake",
								icon: '/img/icons/16x16/form.png',
                                target: '/tools/lousurvey'
							}*/
                        ]
                    }
                },
