				...
				itemclick: {
					...
					fn: function( view, record, item, index ){
						if ( record.data.news_id != null ) {
							...
							console.log("hep", record.data.news_id);
						}
						else { console.log("hep2", record.data.news_id); }
					}
				}
			}
		});
    ...
    ,getNewsFormItems: function( newsData ) {
		...
		var newsFormItems = [
		        ...
		        },
		        {
                                ...
                                items: [
                                        { boxLabel: 'Uutinen', inputValue: 'uutinen', checked: newsData.news_type },
                                        { boxLabel: 'Tapahtuma', inputValue: 'tapahtuma', checked: newsData.news_type }
                                ]
