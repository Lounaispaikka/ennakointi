...
Ext.define('Lougis.view.EnnakointiCharts', {
    extend: 'Lougis.view.Panel',
    alias: 'widget.ennakointicharts',
    id: 'LougisEnnakointiCharts',
	anchor: '100% 100%',
	border: 0,
    items: [],
    treeData: [],
    ...
    ,createChartTreePanel: function() {
        ...
        this.chartTreeStore = Ext.create('Ext.data.TreeStore', {
			...
			proxy: {
				type: 'ajax',
				url: '/run/lougis/ennakointiCharts/getChartsJson/'
			},
			folderSort: false,
			root: null
		});
			...
			items: [
                             ...
                             
		        {
		            ...
		            name: 'chart[short_description]',
                            ...
                            height: 80,
                            maxLength: 255,
                            maxLengthText: 'Virhe: Pituus saa olla enintään 255 merkkiä',
