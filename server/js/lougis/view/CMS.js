Ext.define('Lougis.view.CMS', {
    ...
    initComponent: function() {
		...
		this.parentPageStore = Ext.create('Lougis.store.ParentPages', {
                storeId: 'parentPageStore'
            });
		this.parentPageStore.load();
		...
		this.pageTypeCombo = Ext.create('Ext.form.ComboBox', {
		    ...
		    store: Ext.create('Ext.data.Store', {
			    ...
			    data : [
					...
					{"page_type": "toimiala", "title": "Toimiala"},
					{"page_type": "teema", "title": "Ennakointiteema"},
					{"page_type": "teema_aineisto", "title": "Ennakointiaineisto (teeman alasivu)"}
			        /* Ympäristöohjelman tyypit
