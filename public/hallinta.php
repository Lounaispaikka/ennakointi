...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fi" lang="fi"> 
   <head>
     ...
     <meta http-equiv="X-UA-Compatible" content="IE=8">
        ...
        <script type="text/javascript" src="/js/ext407/ext-all-debug-w-comments.js"></script>
		...
		<script type="text/javascript" src="/js/lougis/view/Testi.js"></script>
		
        <script type="text/javascript" src="/js/ymparisto/view/Toimenpide.js"></script>
		<script type="text/javascript" src="/js/lougis/view/Ennakointi.js"></script>
		<script type="text/javascript" src="/js/lougis/view/Tietopankki.js"></script>
		<script type="text/javascript" src="/js/lougis/view/Toimialat.js"></script>
